...
use Bread\Calendar\Drivers\EWS\Exception;
use Bread\Calendar\Drivers\EWS\NTLMSoapClient\Exchange;
...
class ExchangeWebServices
{
     ...
     *            one of the ExchangeWebServices::VERSION_* constants
     */
    public function __construct($server = null, $username = null, $password = null, $version = self::VERSION_2007)
    {
     ...
     *
     * @return NTLMSoapClient\Exchange
     */
    ...
    {
        $this->soap = new Exchange(dirname(__FILE__) . '/wsdl/services.wsdl', array(
            'user' => $this->username,
