 ...
 */
class Disposal  extends Type
{

    /**
     * Deletes the item irrevocably.
     * Does not move the item to the Deleted Items
     * Folder.
     *
     * @var string
     */
     ...
     * actually still exists there.
     * Avoid using this because there is nothing
